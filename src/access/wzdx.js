...
const Wzdx = () => {
  ...
  const params = { slug: "/api/list-public-api", entityname: "WZDxFeed" };
    ...
    <div className={classes.main}>
      ...
      <div className={classes.footer}>
        <div>
          ...
          <a href="mailto:wzdxfeed@navjoyinc.com" target="_self">
            {" "}
            wzdxfeed@navjoyinc.com
          </a>
        </div>
        <div>
          Reference :{" "}
          <a href="https://github.com/usdot-jpo-ode/wzdx" target="_blank">
