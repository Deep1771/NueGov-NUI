...
export const SystemNumber = (props) => {
  const {
    callbackValue,
    compIndex,
    data,
  ...
  const fieldmeta = {
    ...SystemNumber.defaultProps.fieldmeta,
    ...props.fieldmeta,
  };
  const {
    canUpdate,
...
export default GridWrapper(SystemNumber);
