...
//           data.map((item) =>
//             entity.update(
//               { ...params, entityname: childEntity, id: item._id },
//               item
//             )
//           )
//         );
...
//     let definition = entityTemplate.sys_entityAttributes.sys_topLevel.find(
...
//     if (type === "new") setShowModal(false);
//     else setEdit(false);
...
//                         mode={mode}
//                         entityDoc={item}
//                         entityTemplate={getTemplate(item)}
//                         handleView={handleView}
//                         quickEntities={getQuickEntities(
//                           templateData,
//                           childEntity,
//                           item.sys_agencyId
//                         )}
